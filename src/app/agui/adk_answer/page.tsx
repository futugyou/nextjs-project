        ...
        return (
          <div className="p-3 bg-blue-50 rounded-lg border border-blue-100">
            <div className="flex items-center gap-2">
              ...
              <span className="text-blue-700 text-sm font-medium">Parsing your request...</span>
            </div>
          </div>
        )
        return null
      ...
      return (
        <div className="p-3 bg-gray-50 rounded-lg border border-gray-100">
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs text-gray-500">{state.answer}</span>
          </div>
        </div>
      )
    },
  ...
  return (
    <div>
      ...
      >
        ...
        <p>
          <strong>Answer:</strong> {state.answer || 'Waiting for response...'}
        </p>
