          ...
          suggestions={[
            {
              ...
              message:
                'Based on the current energy consumption, how can I reduce the total power consumption by half? Please thoroughly assess the status of all lights before taking any action.',
            },
            {
              title: 'Prompt trigger `Thought` with high probability',
              message:
                "The current power load is very high. Please first check the status of all the lights. If both the 'living room chandelier' and the 'study desk lamp' are on, to prevent a power outage, please turn off only the light with the highest power consumption. If only one light is on, maintain the current state. Please consider your actions carefully before proceeding.",
            },
          ]}
        />
      </div>
